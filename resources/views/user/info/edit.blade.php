...
<div class="panel panel-default">
        ...
        <div class="panel-body">
            <br>
            <form method="POST" enctype="multipart/form-data" action="/user/info/{{ Auth::user()->id }}">
                @csrf
                {{ method_field('PUT') }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="description" value="{{ Auth::user()->description }}" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" required autocomplete="description">
                ...
                <label>Ava File   </label>
                <input style="margin-left: 30px" name="file" type="file">
                <input type="text" name="file_old" readonly value="{{Auth::user()->image}}">
                </div>
